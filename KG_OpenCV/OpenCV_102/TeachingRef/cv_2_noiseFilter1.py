# https://drive.google.com/file/d/1mCRUQrEhrAMaq-x8ywqGdeO0o0Jkfjzh/view
# https://www.youtube.com/watch?v=b5__Jz7BpCQ&list=PLgkpDfSY2Bez0l8oyY0UNGusnk1ZFH7On&index=3
...
while True:
    ...
    noise = np.uint8(np.random.normal(loc=0, scale=0.4, size=[480, 640, 3])) # 높,폭,색: size=frame.shape 로 해도 됨.
