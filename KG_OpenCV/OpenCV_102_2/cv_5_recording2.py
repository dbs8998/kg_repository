# 'r' 누르면 영상 녹화, 'c' 영상 화면 캡쳐
# 미션 수행: 위 기능 구현

import cv2
import datetime
from PIL import ImageFont, ImageDraw, Image # 폰트처리, 도형/주석 등 그래픽 요소 추가,  넘파이로 이미지 데이터 처리
import numpy as np
...
while True:
    ...
    # 미션1: r 녹화시작 / 중지, c 화면 캡쳐 (25분 후 공개)
